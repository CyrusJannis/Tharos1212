...
async def on_interaction(interaction):
    ...
    if interaction.data["custom_id"] == "jocontact":
        ...
        if can_continue == True:
            ...
            async def btn99_callback(interaction):
                ...
                async def modal2_callback(interaction):
                    ...
                    await jpexpertchannel.send(embed=embed, view=view6)
                    ...
                    await jpclientchannel.send(embed=embed3, view=view55)
        ...
        message = interaction.message.id
        buttonyes = Button(label="I am sure I want to delete it", style=nextcord.ButtonStyle.red, custom_id="jpclientdelete", color=0xFFA404)
        view = View(timeout=None)
        view.add_item(buttonyes)
        ...
        client1 = interaction.guild.get_member(clientid)
        ...
        await owclientchannel.send(embed=embed1, view=view)
        ...
        await owexpertchannel.send(embed=embed2, view=view2)
...
client.run("MTA0OTQwMzI5ODUwMDgzNzM3Nw.Gz3dXF.kMX2gSE-7X-2dqLiWNNUMPR_ZJs2XeUNs9G_bQ")