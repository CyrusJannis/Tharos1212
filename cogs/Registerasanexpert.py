...
class Registerasanexpert(commands.Cog):
    ...
    async def raae(self, ctx):
        ...
        button1 = Button(label="continue", style=nextcord.ButtonStyle.blurple)
        async def button1_callback(interaction):
            ...
            view2 = View(timeout=None)
            view2.add_item(button2)
            embed = nextcord.Embed(description="Please note that it is prohibited to to bypass the THAROS payment system. For violation of this rule an Expert can be kicked.", color=0x35C5FF)
