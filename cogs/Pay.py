    ...
    async def pay(self, ctx):
        ...
        if ctx.channel.category_id == 1009828164928807012:
            ...
            if status == "b":
                ...
                embed = nextcord.Embed(description="Please enter the amount you want the customer to pay for your work. For amounts over 40$ you will receive approximately 80% of the amount. For more detailed information visit 'Information for Experts'. Then enter the maximum time the job will take. Please note that after this period the customer can ask for their money back. Send !happy before this time passed.", color=0x0BBAB5)
